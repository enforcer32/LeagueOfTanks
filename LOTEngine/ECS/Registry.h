...
#include "LOTEngine/ECS/Types.h"
#include "LOTEngine/ECS/ComponentPool.h"
...
namespace LOT
{
	...
	public:
		...
		void AddSystem(Args&& ...args)
		{
			...
			LOT_LOG_DEBUG("System({}) Added!", (typeid(T).name()));
		}
		...
		void RemoveSystem()
		{
			...
			LOT_LOG_DEBUG("System({}) Removed!", typeid(T).name());
		}
		...
		T& GetSystem()
		{
			LOT_ASSERT((m_Systems.find(std::type_index(typeid(T))) != m_Systems.end()), "");
	...
	public:
		...
		void AddComponent(Entity entity, Args&& ...args)
		{
			...
			LOT_LOG_DEBUG("Entity({}) Added Component({})", entityID, componentID);
		}
		...
		void RemoveComponent(Entity entity)
		{
			...
			LOT_LOG_DEBUG("Entity({}) Removed Component({})", entityID, componentID);
		}
